...
const Login = () => {
  ...
  return (
    <>
     <div className="container-fluid  wow fadeIn" data-wow-delay="0.2s">
    ...
    <div className="container pt-7" style={{paddingTop:'40px',color:"black"}}>
    <div className="row justify-content-center">
      <div className="col-md-6 ms-5">
      <div className="row ms-4">
          <div className="col-md-6 d-flex pt-4 ">
